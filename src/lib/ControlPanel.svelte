...
<div
    class="absolute bottom-4 sm:bottom-6 flex flex-col space-y-4 px-auto 2xl:ml-4 bg-violet-900 p-4 md:p-8 rounded-lg bg-opacity-50 w-full 2xl:w-auto"
>
    <div
        class="flex flex-col md:flex-row space-x-4 2xl:space-x-0 space-y-4 md:space-y-0 items-center justify-center"
    >
    ...
    >
        ...
        <progress class="progress w-56 my-4" value={progress} max={interval} />
    </div>
</div>
